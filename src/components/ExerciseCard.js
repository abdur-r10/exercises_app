...
export default function ExerciseCard(props) {
    return (
        <Link className='exercise-card' to={`/exercise/${props.exercise.id}`}>
            ...
            <Stack direction='row'>
                <Button sx={{ ml: '21px', color: '#fff', background: '#ffa9a9', fontSize: '14px', borderRadius: '20px', tetTransform: 'capitalize'}}>
                    {props.exercise.bodyPart}
                </Button>

                <Button sx={{ ml: '21px', color: '#fff', background: '#fcc757', fontSize: '14px', borderRadius: '20px', tetTransform: 'capitalize'}}>
